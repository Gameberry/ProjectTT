...
{
    public class UIShopElementDaily_Group : UIShopElement_Group
    {
        [SerializeField]
        ...
        public override void SetShopElement()
        {
            ...
            if (ShopPackageDatas != null)
                ShopPackageDatas = ShopPackageDatas.FindAll(x => x.IntervalType == V2Enum_IntervalType.Day && x.MenuType == V2Enum_ShopMenuType.Daily);
