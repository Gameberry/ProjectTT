...
{
    public class UIShopElementWeek_Group : UIShopElement_Group
    {
        [SerializeField]
        ...
        public override void SetShopElement()
        {
            ...
            if (ShopPackageDatas != null)
                ShopPackageDatas = ShopPackageDatas.FindAll(x => x.IntervalType == V2Enum_IntervalType.Week && x.MenuType == V2Enum_ShopMenuType.Weekly);
            ...
            Managers.TimeManager.Instance.RemainInitWeekContent_Text += SetInitInterval;
        }
        //------------------------------------------------------------------------------------
