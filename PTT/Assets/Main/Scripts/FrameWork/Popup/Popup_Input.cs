...
namespace GameBerry.UI
{
    public class Popup_Input : MonoBehaviour
    {
        ...
        //------------------------------------------------------------------------------------
        public void Show(string titletext, string defaultstr, string placeholder, System.Action<string> okAction, System.Action cancelAction, System.Action<bool> toDayHide, System.Action<Popup_Input> endHideAction)
        {
            if (m_titleText != null)
