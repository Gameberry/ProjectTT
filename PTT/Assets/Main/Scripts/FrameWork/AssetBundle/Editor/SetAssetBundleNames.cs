...
namespace GameBerry
{
    ...
    {
        //------------------------------------------------------------------------------------
        [MenuItem("Assets/_GameBerry/AssetBundle Names/ResetBundleName", false, 500)]
        [MenuItem("_GameBerry/AssetBundle Names/ResetBundleName", false, 34)]
        static void ResetBundleName()
        {
        ...
        //------------------------------------------------------------------------------------
        public static void ResetNames(string path)
        {
