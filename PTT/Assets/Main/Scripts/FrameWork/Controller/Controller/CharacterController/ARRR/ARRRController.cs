...
namespace GameBerry
{
    public class ARRRController : CharacterControllerBase
    {
        ...
        private Dictionary<SkillBaseData, SkillInfo> ARRRSkillInfos = new Dictionary<SkillBaseData, SkillInfo>();


        private Dictionary<PetData, PetController> _petDictionary = new Dictionary<PetData, PetController>();


        private List<MoveController_TargetPos> _moveController_List = new List<MoveController_TargetPos>();
