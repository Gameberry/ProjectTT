...
namespace GameBerry
{
    public static class SummonTicketContainer
    {
        public static Dictionary<int, ObscuredDouble> m_summonTicketAmount = new Dictionary<int, ObscuredDouble>();
        ...
        public static string GetSerializeString()
        {
            ...
            foreach (var pair in m_summonTicketAmount)
            {
                SerializeString.Append(pair.Key - 172010000);
        ...
        public static void SetDeSerializeString(string data)
        {
            ...
            for (int i = 0; i < arr.Length; ++i)
            {
                ...
                m_summonTicketAmount.Add(arrcontent[0].ToInt() + 172010000, amount);
