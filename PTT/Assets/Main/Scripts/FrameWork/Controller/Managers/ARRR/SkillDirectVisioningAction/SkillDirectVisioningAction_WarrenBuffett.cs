...
namespace GameBerry
{
    public class SkillDirectVisioningAction_WarrenBuffett : SkillDirectVisioningAction
    {
        [SerializeField]
        protected SkeletonAnimationHandler _mySkeletonAnimationHandler;

        [SerializeField]
        private string _idleAni;
        ...
        [SerializeField]
        private float _targetXposGab = 1.0f;
        ...
        public override void Init()
        {
            if (_mySkeletonAnimationHandler != null)
            {
                ...
                _mySkeletonAnimationHandler.AnimationList_Dic.Add(_idleAni, null);
        ...
        public override void Play()
        {
            ...
            _mySkeletonAnimationHandler.PlayAnimation_Once(_idleAni, false);
