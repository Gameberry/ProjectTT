...
namespace GameBerry
{
    public sealed class CombatTextSpawner : MonoSingleton<CombatTextSpawner>
    {
        ...
        [SerializeField] private Vector3 BASE_WORLD_COMBO = new(0f, 1.2f, 0f);
        [SerializeField] private Vector3 BASE_WORLD_MISS = new(0f, 1.0f, 0f);
        [SerializeField] private Vector3 BASE_WORLD_CRIT = new(0f, 1.0f, 0f);
