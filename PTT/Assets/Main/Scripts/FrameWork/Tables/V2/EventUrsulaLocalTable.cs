...
namespace GameBerry
{
    public class EventUrsulaLocalTable : LocalTableBase
    {
        ...
        public override async UniTask InitData_Async()
        {
            ...
            TheBackEnd.TheBackEnd_GameChart.GetBackEndChart("UrsulaDungeon", o =>
            { rows = o; });
            ...
            for (int i = 0; i < rows.Count; ++i)
            {
                ...
                crackDungeonData.WaveMonsterGroup.Add(106010500);
            ...
            TheBackEnd.TheBackEnd_GameChart.GetBackEndChart("UrsulaDungeonClearReward", o =>
            { rows = o; });
            ...
            TheBackEnd.TheBackEnd_GameChart.GetBackEndChart("UrsulaDungeonRankReward", o =>
            { rows = o; });
            ...
            TheBackEnd.TheBackEnd_GameChart.GetBackEndChart("UrsulaDungeonSummonRewardOnce", o =>
            { rows = o; });
            ...
            TheBackEnd.TheBackEnd_GameChart.GetBackEndChart("UrsulaDungeonMission", o =>
            { rows = o; });
            ...
            for (int i = 0; i < rows.Count; ++i)
            {
                ...
                eventRouletteMissionData.ClearRewardParam1 = V2Enum_Point.UrsulaPick.Enum32ToInt();
            ...
            TheBackEnd.TheBackEnd_GameChart.GetBackEndChart("UrsulaDungeonSummon", o =>
            { rows = o; });
            ...
            TheBackEnd.TheBackEnd_GameChart.GetBackEndChart("UrsulaDungeonPass", o =>
            { rows = o; });
